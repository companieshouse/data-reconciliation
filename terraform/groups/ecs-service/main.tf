...
module "ecs-service" {
  ...
  enable_scheduler                   = var.enable_eventbridge_scheduler
  startup_scheduler_cron             = var.startup_eventbridge_scheduler_cron
  shutdown_scheduler_cron            = var.shutdown_eventbridge_scheduler_cron

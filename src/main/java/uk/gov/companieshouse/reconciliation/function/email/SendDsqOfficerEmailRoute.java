...
import uk.gov.companieshouse.reconciliation.function.email.aggregator.DsqOfficerEmailAggregationStrategy;
...
public class SendDsqOfficerEmailRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        from("direct:send-dsq_officer-email")
                .aggregate(constant(true), new DsqOfficerEmailAggregationStrategy())
                .completionSize(1)

...
/**
 * Publishes {@link PublisherResourceRequest resource requests} by uploading CSV files to S3,
 * assigning a pre-signed url for each request and finally puts the url into a ResourceLinkReference header.
 */
@Component

...
public class EmailLinksSorterTest {
    ...
    void setUp() {
        ...
        emailId = "email-id";
        Map<String, EmailLinkModel> emailLinkModelMap = new HashMap<String, EmailLinkModel>() {{
        ...
        ComparisonGroupModel comparisonGroupModel = new ComparisonGroupModel();
        comparisonGroupModel.setGroupName(emailId);
        comparisonGroupModel.setEmailLinkModel(emailLinkModelMap);
        Map<String, ComparisonGroupModel> comparisonGroupModelMap = new HashMap<String, ComparisonGroupModel>(){{
            put(emailId, comparisonGroupModel);
        }};
        aggregationHandler = new AggregationHandler(comparisonGroupModelMap);
    }
...
//        // given
//        EmailLinksSorter emailLinksSorter = new EmailLinksSorter(aggregationHandler);
//
